application_project :wifidebugger, File.dirname(__FILE__) do |app|
  ...
  app.add_configuration :Debug,
    ...
    toolchain: toolchain(:arm_none_eabi_gcc,
      ...
      'CC3200_SDK_simplelink:SDK_freertos_multithread_full', 'CC3200_SDK_driverlib:SDK', 'FreeRTOS:Debug', 'CC3200_SDK_inc:SDK', 'CC3200_SDK_oslib:SDK', 'cc3200_flashstub_inc:Protocol', 'cc3200_flashstub:Release'
    ]
